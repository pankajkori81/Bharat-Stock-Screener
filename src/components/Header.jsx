...
//               <h1 className={`text-base sm:text-xl font-bold leading-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>Bharat Stock Screener</h1>
//               <p className={`text-xs sm:text-sm ${isDark ? 'text-gray-400' : 'text-gray-500'} mt-0.5 sm:mt-1`}>Explore Potential Multibagger Stocks</p>
//             </div>
//           </Link>
...
//             <Link to="/pages/contact" className={`flex items-center gap-2 px-4 py-2 rounded-lg ${isDark ? 'bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-indigo-400' : 'bg-gray-50 text-gray-700 hover:bg-indigo-50'} transition font-medium`}>
//               <Mail size={18} /> Contact
//             </Link>
//             <Link to="/pages/feedback" className={`flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition font-medium`}>
//               <MessageSquare size={18} /> Feedback
//             </Link>

//               <Link to="/support/about" className={`flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 transition font-medium`}>
//               About
//             </Link>
...
//             <Link to="/pages/contact" className={`block px-4 py-2 rounded flex items-center gap-2 ${isDark ? 'text-gray-300 hover:bg-gray-700' : 'text-gray-700 hover:bg-indigo-50'}`}>
//               <Mail size={18} /> Contact
//             </Link>
//             <Link to="/pages/feedback" className={`block px-4 py-2 text-indigo-600 hover:bg-indigo-50 rounded flex items-center gap-2 font-medium`}>
//               <MessageSquare size={18} /> Feedback
//             </Link>

//              <Link to="/support/about" className={`block px-4 py-2 text-indigo-600 hover:bg-indigo-50 rounded flex items-center gap-2 font-medium`}>
//               About
//             </Link>
//           </div>
//         )}
